...
import pistalix.ChristmasPhotoStickerFrames.PhotoEditor.BackButton;
           ...
           public void onResponse(JSONObject response) {
               try {
                   ...
                   while(i<responseArray.length()){
                       if(!responseArray.getJSONObject(i).get("packeg").equals("pistalix.ChristmasPhotoStickerFrames.PhotoEditor")){
