...
import pistalix.crismasImage.editor.Adepter.EffectAdapter;
import pistalix.crismasImage.editor.R;
import pistalix.crismasImage.editor.Subfile.Effects;
import pistalix.crismasImage.editor.Subfile.Glob;
import pistalix.crismasImage.editor.modul.EffectModel;
import pistalix.crismasImage.editor.textdemo.FontFace;
import pistalix.crismasImage.editor.textdemo.FontList_Adapter;
import pistalix.crismasImage.editor.textdemo.GradientManager;
import pistalix.crismasImage.editor.textdemo.OnTouch;
import pistalix.crismasImage.editor.textdemo.StickerAdapter;
import pistalix.crismasImage.editor.textdemo.StickerView;
...
//                        main_frame.removeView(stickerView);
                ...
                main_frame.addView(stickerView, lp);
...
//                        main_frame.removeView(stickerView);
                ...
                FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
                main_frame.addView(BeardView, lp);
...
//                        main_frame.removeView(stickerView);
                ...
                FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
                main_frame.addView(CapView, lp);
                mViews.add(CapView);
                setCurrentEdit(CapView);
                Log.e("mViews.size", String.valueOf(mViews.size()));
            }
        });
