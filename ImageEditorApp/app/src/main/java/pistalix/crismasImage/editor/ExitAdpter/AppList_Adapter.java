...
public class AppList_Adapter extends BaseAdapter {
    ...
    public AppList_Adapter(Activity dAct, ArrayList<String> dLinkUrl, ArrayList<String> dIcon, ArrayList<String> dName) {
        activity = dAct;
        this.dLink = dLinkUrl;
        this.dName = dName;
        this.dIcon = dIcon;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = LayoutInflater.from(activity).inflate(R.layout.list_appstore, parent, false);
