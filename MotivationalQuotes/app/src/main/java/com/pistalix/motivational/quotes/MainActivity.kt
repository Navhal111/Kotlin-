            ...
            try{
                ...
                val jsonobj2 = JsonObjectRequest(Request.Method.GET, url,null,
                        Response.Listener<JSONObject> {
                            response ->
                            try{
                                val Newvirsion : JSONObject = response.getJSONObject("Motivational")
    ...
    override fun onBackPressed(){
        ...
        try{
            ...
            rate.setOnClickListener{
                try {
                    startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.pistalix.motivational.quotes")))
                } catch (anfe: android.content.ActivityNotFoundException) {
                    startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.pistalix.motivational.quotes")))
                }
            }
            dailog.show()
        }catch (e :NullPointerException){
